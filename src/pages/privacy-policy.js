...
import { RichText, Heading, Meta, Text } from "@/components/common";
import { Static } from "@/layouts";
import Head from "next/head";

const PrivacyPolicy = () => {
  return (
    <>
      <Meta title="Privacy policy — LVGL" />
      <Static title="Privacy policy">
        <RichText type="html" size="md">
          <Text size="xl">
            At LVGL, accessible from lvgl.io, one of our main priorities is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and recorded by LVGL and how we use it.
          </Text>
          <p>
          ...
          <p>
            ...
            regards to the information that they shared and/or collect in LVGL. This policy is not applicable to any
          ...
          <ul>
            ...
            <li>and other information relating to the website, and for marketing and promotional purposes</li>
          ...
          <p>
            LVGL follows a standard procedure of using log files. These files log visitors when they visit websites. All
            ...
            <Link href="https://www.disclaimergenerator.org/">Disclaimer Generator</Link>.
          </p>
          <Heading as="h2" size="h3">
            Cookies and Web Beacons
          </Heading>
          <p>
            Like any other website, LVGL uses “cookies”. These cookies are used to store information including visitors’
          ...
          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of LVGL.</p>
          <p>
            Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on LVGL, which are sent directly to users’
          ...
          <p>Note that LVGL has no access to or control over these cookies that are used by third-party advertisers.</p>
          <Heading as="h2" size="h3">
            Third Party Privacy Policies
          </Heading>
          <p>
            LVGL’s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
          ...
          <p>
            LVGL does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
